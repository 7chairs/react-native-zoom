...
public class RNZoomInMeetingServiceListener implements InMeetingServiceListener {
    ...
    public RNZoomInMeetingServiceListener(ReactApplicationContext context, InMeetingService inMeetingService) {
